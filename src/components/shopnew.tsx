    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const newProducts = response.data.filter((product: Product) => product.isNew);
            ...
            <div className='flex p-10 gap-5'>
                <div className='flex flex-col gap-2 w-1/5'>
                    ...
                    <h2 className="text-xl font-semibold mt-4">Filter by</h2>
                        <div className="flex flex-col">
                            <label className="flex items-center cursor-pointer mb-3 px-3 py-2 bg-gray-100 text-black w-36" onClick={() => navigate('/new-arrival')}>
                                New Arrival
                            </label>
