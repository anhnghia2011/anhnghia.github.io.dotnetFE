...
function Shoprun() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const response = await axios.get('http://localhost:5099/api/Products/category/6');
                ...
                <div className="flex p-10 gap-5">
                    <div className="flex flex-col gap-2 w-1/5">
                        ...
                        <div className="flex flex-col">
                            ...
                            <label className="flex items-center cursor-pointer mb-3  px-3 py-2 bg-gray-100 text-black w-36" onClick={() => navigate('/yoga-shoe')}>
                                Yoga
                            </label>
                        </div>
