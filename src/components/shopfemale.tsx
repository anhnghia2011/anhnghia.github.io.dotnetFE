...
function Shoprun() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const response = await axios.get('http://localhost:5099/api/Products/gender/Female');
            ...
            <div className='flex p-10 gap-5'>
                <div className='flex flex-col gap-2 w-1/5'>
                    ...
                    <h2 className="text-xl font-semibold mt-4">Filter by</h2>
                        <div className="flex flex-col">
                            ...
                            <label className="flex items-center cursor-pointer mb-3 px-3 py-2 bg-gray-100 text-black w-36" onClick={() => navigate('/female')}>
                                Women
                            </label>
                            <label className="flex items-center cursor-pointer mb-3" onClick={() => navigate('/kid')}>
                                Kid
                            </label>
                            <label className="flex items-center cursor-pointer mb-3" onClick={() => navigate('/sale')}>
                                Sale
                            </label>
                        </div>
                </div>
                ...
                <div className="w-4/5 flex flex-col">
                    <div className="flex justify-between p-4 mb-3 border rounded-xl">
                        <h2 className="text-2xl font-semibold">Women's Shoes</h2>
